...
class LPDNetConfig(ModelConfig):
    ...
    primal_uformer_encoder_depths: tuple[int, ...] = (2, 2, 2)
    primal_uformer_encoder_num_heads: tuple[int, ...] = (2, 4, 8)
    ...
    dual_uformer_encoder_depths: tuple[int, ...] = (2, 2, 2)
    dual_uformer_encoder_num_heads: tuple[int, ...] = (2, 4, 8)
